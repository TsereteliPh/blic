...
<header class="header<?php echo ( is_privacy_policy() || is_page( 66 ) || is_page( 221 ) || is_page( 190 ) || is_page( 267 ) || is_404() ) ? ' header--colored' : ''; ?>">
	<div class="container">
...
<main class="main<?php echo ( is_privacy_policy() || is_page( 66 ) || is_page( 267 ) || is_404() ) ? ' main--indent' : ''; ?>">
