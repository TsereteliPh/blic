...
if (!function_exists('tsereteli_setup')) {
	function tsereteli_setup()
	{
...
add_action('after_setup_theme', 'tsereteli_setup');

// Return classic widgets
add_filter('gutenberg_use_widgets_block_editor', '__return_false');
add_filter('use_widgets_block_editor', '__return_false');

add_action('wp_enqueue_scripts', 'tsereteli_scripts');
function tsereteli_scripts()
{
	...
	wp_enqueue_style('tsereteli', get_stylesheet_uri(), array(), _S_VERSION);
	wp_enqueue_script('tsereteli', get_template_directory_uri() . '/assets/js/main.min.js', array(), _S_VERSION, true);
	wp_localize_script('tsereteli', 'tsereteli_ajax', array('url' => admin_url('admin-ajax.php')));
}
...
// excerpt
function tsereteli_excerpt($limit, $ID = null)
{
